...
if __name__ == "__main__":
    ...
    parser.add_argument("--random_cache", action="store_true", default=False, help="使用随机缓存位置")
    ...
    runner.sample_fid_position_matrix(model, total_n_samples=args.num_samples)
