...
def main():
    ...
    parser.add_argument("--config", type=str, default="predictor_ddim_cifar10.yml", help="predictor configs")
    ...
    parser.add_argument("--exp", type=str, default="randomddpm/predictor/exps/debug", help="dir to save the result of this experiment")
    ...
    args.config = os.path.join("randomddpm/predictor/configs", args.config)
    ...
    if args.type=="train":
        ...
        test( predictor, valid_loader, logger)
