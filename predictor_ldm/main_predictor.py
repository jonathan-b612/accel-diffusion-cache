...
def main():
    ...
    parser.add_argument("--config", type=str, default="predictor_ddim_imagenet.yml", help="predictor configs")
    ...
    parser.add_argument("--exp", type=str, default="randomldm/predictor/exps/debug", help="dir to save the result of this experiment")
    ...
    args.config = os.path.join("randomldm/predictor/configs", args.config)
